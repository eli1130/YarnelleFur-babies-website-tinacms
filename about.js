    ...
    <>
      ...
      <section className="family-section alt">
        <div className="family-inner">
          ...
          <div className="photo-grid-featured">
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0015.jpg" alt="John and Kathy Yarnelle" />
            <div className="right-col">
              <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0012.jpg" alt="The Yarnelle Farm" />
              <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0021.jpg" alt="Yarnelle property" />
            </div>
          </div>
      ...
      <section className="family-section">
        <div className="family-inner">
          ...
          <div className="photo-grid-3">
            ...
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0040.jpg" alt="Hannah with puppies" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0041.jpg" alt="Mullendore kids with puppies" />
          </div>
          <div className="family-bio">
      ...
      <section className="family-section alt">
        <div className="family-inner">
          ...
          <div className="photo-grid-3">
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0018.jpg" alt="Hunter and Sarah Nicodemus" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0042.jpg" alt="Sarah with puppies" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0043.jpg" alt="Nicodemus kids with puppies" />
          </div>
          <div className="family-bio">
      ...
      <section className="family-section">
        <div className="family-inner">
          ...
          <div className="photo-grid-3">
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0016.jpg" alt="Dakoda and Brooke Labenz" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0044.jpg" alt="Brooke with puppies" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0045.jpg" alt="Labenz girls with puppies" />
          </div>
          <div className="family-bio">
      ...
      <section className="family-section alt">
        <div className="family-inner">
          ...
          <div className="photo-grid-3">
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0047.jpg" alt="Visiting Seth's grave" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0019.jpg" alt="Seth Yarnelle" />
            <img src="https://res.cloudinary.com/dyzfpnrhg/image/upload/image_0046.jpg" alt="Luke and Eli with dogs" />
          </div>
          <div className="family-bio">
