...
export default function AllLitters({ litters }) {
  ...
  return (
    <>
      <Head>
        <title>All Litters | Yarnelle Fur-Babies</title>
        <meta name="description" content="Browse every current litter from every Yarnelle Fur-Babies family, filterable by breed." />
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-hero p { color: #aaa; font-size: 1rem; max-width: 560px; margin: 0 auto; line-height: 1.8; }
        ...
        .litters-section { padding: 4rem 4rem 6rem; max-width: 1300px; margin: 0 auto; }
        .breed-filters { display: flex; flex-wrap: wrap; justify-content: center; gap: 0.6rem; margin-bottom: 3rem; }
        .breed-filter-btn { border: 1px solid var(--light-gray); background: var(--white); color: var(--text); padding: 0.5rem 1.2rem; font-size: 0.72rem; letter-spacing: 0.08em; text-transform: uppercase; border-radius: 2px; cursor: pointer; font-family: 'Jost', sans-serif; transition: all 0.2s; }
        .breed-filter-btn:hover { border-color: var(--red); color: var(--red); }
        .breed-filter-btn.active { background: var(--red); border-color: var(--red); color: var(--white); }
        ...
        .litter-card-body h3 { font-family: 'Cormorant Garamond', serif; font-size: 1.35rem; font-weight: 400; color: var(--black); margin-bottom: 0.4rem; line-height: 1.2; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
        .litter-desc { font-size: 0.82rem; color: var(--text-light); line-height: 1.6; margin-bottom: 1rem; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
        ...
        @media (max-width: 900px) {
          ...
          .litters-section { padding: 3rem 1.5rem 4rem; }
      ...
      <section className="page-hero">
        <span className="overline">Every Family, Every Litter</span>
        <h1>All <em>Litters</em></h1>
        <p>Browse every current litter across all five Yarnelle Fur-Babies families. Filter by breed to see who has what right now.</p>
      </section>

      <section className="litters-section">
        <div className="section-header">
          <span className="overline">Filter by Breed</span>
          <h2>Find Your <em>Perfect Match</em></h2>
        </div>
        ...
        {groups.length === 0 ? (
          <div className="empty-state">
            <h3>No litters match that filter right now</h3>
            <p>Check back soon, or submit an application and we'll reach out when a matching litter is ready.</p>
          </div>
        ) : (
          groups.map((group) => (
